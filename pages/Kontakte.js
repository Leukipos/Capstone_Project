...
export default function About(){
    return(
        ...
        <StyledHeader/>
        <StyledModules>
        <StyledCard><StyledCardTitle>Hausarzt</StyledCardTitle>
        ...
        <StyledCard><StyledCardTitle>Bei Suizidgedanken</StyledCardTitle>
        ...
        <StyledCard><StyledCardTitle>Bei Depressionen</StyledCardTitle>
        ...
        <StyledCard><StyledCardTitle>Erste Hilfe bei Trauer</StyledCardTitle>
        ...
        <StyledCard><StyledCardTitle>Gewalt gegen Frauen</StyledCardTitle>
        ...
        <StyledCard><StyledCardTitle>Erste Hilfe bei Essstörungen</StyledCardTitle>
